...
export async function getStaticProps() {
  ...
  * Exclusive Digital Comic - Cyberpunk 2077: Big City Dreams is available in English only.
  ...
  return {
    props: {
      cover:
        'https://cdn.ome.lt/I-W0dXdCgBAYIOV9dnsdPtSDxco=/1200x630/smart/extras/conteudos/Cyberpunk-2077-1_qPj5RaB.jpg',
      gameInfo: {
      ...
      gameDetails: {
        ...
        releaseDate: '2020-12-10T09:16:00',
        platforms: ['windows'],
